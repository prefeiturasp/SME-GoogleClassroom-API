...
namespace SME.GoogleClassroom.Dados
{
    ...
    {
        Task<PaginacaoResultadoDto<Curso>> ObterTodosCursosAsync(Paginacao paginacao, long? turmaCodigo, long? componenteCurricularId, long? cursoId, string emailCriador);
        ...
        Task<Curso> ObterCursoPorTurmaComponenteCurricular(long turmaId, long componenteCurricularId);
    }
}
