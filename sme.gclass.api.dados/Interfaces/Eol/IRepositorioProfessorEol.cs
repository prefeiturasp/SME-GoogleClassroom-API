...
namespace SME.GoogleClassroom.Dados
{
    public interface IRepositorioProfessorEol
    {
        ...
        Task<IEnumerable<string>> ObterProfessoresPorDreComponenteCurricularModalidade(string codigoDre, string componentesCurricularIds, string modalidadesIds, int[] tipoEscola, int anoLetivo, string anoTurma);
