...
namespace SME.GoogleClassroom.Dados
{
    public interface IRepositorioAlunoEol
    {
        ...
        Task<PaginacaoResultadoDto<GradeCursoEol>> ObterGradesDeCursosDosAlunosAsync(DateTime ultimaDataExecucao, Paginacao paginacao, long? codigoAluno, long? turmaId, long? componenteCurricularId);
    }
}
