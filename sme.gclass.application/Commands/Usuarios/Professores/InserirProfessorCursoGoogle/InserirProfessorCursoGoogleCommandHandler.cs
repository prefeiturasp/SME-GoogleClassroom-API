...
namespace SME.GoogleClassroom.Aplicacao
{
    public class InserirProfessorCursoGoogleCommandHandler : EnvioDeDadosIntegracaoGoogleClassroomHandler<InserirProfessorCursoGoogleCommand>
    {
        ...
        public InserirProfessorCursoGoogleCommandHandler(IMediator mediator, IReadOnlyPolicyRegistry<string> registry, VariaveisGlobaisOptions variaveisGlobaisOptions)
