...
namespace SME.GoogleClassroom.Aplicacao
{
    public class InserirFuncionarioCursoGoogleCommandHandler : EnvioDeDadosIntegracaoGoogleClassroomHandler<InserirFuncionarioCursoGoogleCommand>
    {
        ...
        public InserirFuncionarioCursoGoogleCommandHandler(IMediator mediator, IReadOnlyPolicyRegistry<string> registry, VariaveisGlobaisOptions variaveisGlobaisOptions)
        ...
        private async Task IncluirProfessorCursoNoGoogle(long cursoId, string email, ClassroomService servicoClassroom)
        {
            ...
            var requestCreate = servicoClassroom.Courses.Teachers.Create(funcionarioParaIncluirGoogle, cursoId.ToString());
