...
namespace SME.GoogleClassroom.Aplicacao
{
    public class AtualizarFuncionarioIndiretoGoogleCommandHandler : EnvioDeDadosIntegracaoGoogleClassroomHandler<AtualizarFuncionarioIndiretoGoogleCommand>
    {
        ...
        public AtualizarFuncionarioIndiretoGoogleCommandHandler(IMediator mediator, IReadOnlyPolicyRegistry<string> registry, VariaveisGlobaisOptions variaveisGlobaisOptions, IMetricReporter metricReporter)
