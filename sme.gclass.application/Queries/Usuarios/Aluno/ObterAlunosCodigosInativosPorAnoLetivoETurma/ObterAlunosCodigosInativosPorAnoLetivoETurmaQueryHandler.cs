...
namespace SME.GoogleClassroom.Aplicacao
{
    public class ObterAlunosCodigosInativosPorAnoLetivoETurmaQueryHandler : IRequestHandler<ObterAlunosCodigosInativosPorAnoLetivoETurmaQuery, IEnumerable<long>>
    {
        ...
        {
            return await repositorioAlunoEol.ObterAlunosCodigosInativosPorAnoLetivoETurma(request.AnoLetivo, request.TurmaId, request.DataReferencia, request.TotalDiasInativo);
        }
    }
}
