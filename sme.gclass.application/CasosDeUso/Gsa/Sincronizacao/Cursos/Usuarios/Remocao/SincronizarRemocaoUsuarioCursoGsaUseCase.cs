...
namespace SME.GoogleClassroom.Aplicacao
{
    public class SincronizarRemocaoUsuarioCursoGsaUseCase : ISincronizarRemocaoUsuarioCursoGsaUseCase
    {
        ...
        public async Task<bool> Executar(MensagemRabbit mensagemRabbit)
        {
            ...
            {
                mediator.Send(new SalvarLogViaRabbitCommand($"SincronizarRemocaoUsuarioCursoGsaUseCase - Não foi possível sincronizar a remoção dos usuários curso gsa - CELP", LogNivel.Critico, LogContexto.CelpGsa, ex.Message, ex.StackTrace));
