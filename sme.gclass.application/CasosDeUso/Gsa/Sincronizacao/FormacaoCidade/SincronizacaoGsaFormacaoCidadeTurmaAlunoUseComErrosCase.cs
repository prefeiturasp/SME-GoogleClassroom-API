...
{
    public class SincronizacaoGsaFormacaoCidadeTurmaAlunoComErrosUseCase : AbstractTratarFilaErrosUseCase<SalaComponenteModalidadeDto>, ISincronizacaoGsaFormacaoCidadeTurmaAlunoComErrosUseCase
    {
