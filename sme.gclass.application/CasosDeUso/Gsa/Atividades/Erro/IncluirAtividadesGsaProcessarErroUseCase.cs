...
{
    public class IncluirAtividadesGsaProcessarErroUseCase : IIncluirAtividadesGsaProcessarErroUseCase
    {
        ...
        public async Task Executar()
        {
            ...
            await _policy.ExecuteAsync(() => TratarMensagens(RotasRabbit.FilaGsaAtividadesIncluirErro, factory));
        }
            ...
            using (var conexaoRabbit = factory.CreateConnection())
            {
                using (IModel _channel = conexaoRabbit.CreateModel())
                {
                    while (true)
                    {
                        ...
                        var atividadeGsa = mensagemRabbit.ObterObjetoMensagem<AtividadeGsaDto>();

                        await _mediator.Send(new PublicaFilaRabbitCommand(RotasRabbit.FilaGsaAtividadesIncluir, atividadeGsa));
                    }
                }
            }
        }
