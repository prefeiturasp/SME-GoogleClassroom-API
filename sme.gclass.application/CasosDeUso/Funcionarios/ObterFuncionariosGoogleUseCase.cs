...
namespace SME.GoogleClassroom.Aplicacao
{
    public class ObterFuncionariosGoogleUseCase : IObterFuncionariosGoogleUseCase
    {
        ...
        public async Task<PaginacaoResultadoDto<FuncionarioGoogle>> Executar(int registrosQuantidade, int paginaNumero)
        {
            var paginacao = new Paginacao(paginaNumero, registrosQuantidade);
            return await mediator.Send(new ObterFuncionariosGoogleQuery(paginacao));
        }
    }
}
