...
{
    public class SincronizacaoGsaFormacaoCidadeTurmaCursoErroUseCase : ISincronizacaoGsaFormacaoCidadeTurmaCursoErroUseCase
    {
        private readonly IMediator mediator;

        public SincronizacaoGsaFormacaoCidadeTurmaCursoErroUseCase(IMediator mediator)
        {
