...
{
    public class InserirCursoGoogleUseCaseTeste : TesteIntegracaoGoogleClassroom
    {
        private readonly Mock<IMediator> mediator;
        private readonly IIncluirCursoUseCase incluirCursoUseCase;

        public InserirCursoGoogleUseCaseTeste()
        {
            mediator = new Mock<IMediator>();
            incluirCursoUseCase = new InserirCursoGoogleUseCase(mediator.Object, GerarVariaveisGlobais());
        }
